...
const BillingPanel: React.FC<{ church: Church | null, currentUserId?: string }> = ({ church, currentUserId }) => {
...
const AdminPanel: React.FC = () => {
    ...
    const renderContent = () => {
        ...
        switch (activeTab) {
            ...
            case 'subscription': return <BillingPanel church={church} currentUserId={currentUserId} />;
            default: return null;
        }
    }
