...
const NavLink: React.FC<{
    ...
    <Link
        href={href}
        onClick={onClick}
        className={`w-full flex items-center space-x-3 px-4 py-3 text-sm font-medium rounded-lg ${isActive
...
const Sidebar: React.FC<SidebarProps> = ({ currentUser, isOpen, setIsOpen }) => {
