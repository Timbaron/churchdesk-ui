...
const FinanceDashboard: React.FC<FinanceDashboardProps> = ({ currentUser, navigate }) => {
    ...
    const fetchData = useCallback(async () => {
        ...
        setLoading(true);
        const data = await apiClient.getFinanceOverview(currentUser.section_id, currentUser.id);
        setOverview(data);
        setLoading(false);
    }, [currentUser.section_id, currentUser.id]);
    ...
    if (!overview || !currentUser.section_id) {
